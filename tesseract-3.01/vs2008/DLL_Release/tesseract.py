...
class TessBaseAPI(_object):
    ...
    def SetDictFunc(self, *args): return _tesseract.TessBaseAPI_SetDictFunc(self, *args)
    def SetProbabilityInContextFunc(self, *args): return _tesseract.TessBaseAPI_SetProbabilityInContextFunc(self, *args)
    ...
    def GetLastInitLanguage(self): return _tesseract.TessBaseAPI_GetLastInitLanguage(self)
